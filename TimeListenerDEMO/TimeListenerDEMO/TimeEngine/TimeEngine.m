...
// if DEBUG_START_DATE is not nil, the start date is that date.
// else if nil, the time will current time.
#define DEBUG_START_DATE nil//[NSDate dateWithYear:2014 month:10 day:10 hour:12 minute:59 second:4]
